...
namespace JWTAuthentication
{
    public class Startup
    {
                ...
                c.AddSecurityRequirement(new OpenApiSecurityRequirement {
        {
            ...
            services.AddDbContext<Project2DatabaseContext>(options => options.UseSqlServer(Configuration.GetConnectionString("ConnStr")));

            // For Identity  
            services.AddIdentity<ApplicationUser, IdentityRole>()
                .AddEntityFrameworkStores<Project2DatabaseContext>()
